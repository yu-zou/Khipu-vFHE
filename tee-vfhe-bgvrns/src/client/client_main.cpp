...
// BGV input: integer values in [0, plaintextModulus).
...
// ── Workload specification for deterministic input generation ─────────────────
...
int main(int argc, char** argv) {
    ...
    try {
        ...
        pt_out->SetLength(spec ? static_cast<size_t>(spec->slots) : 64);
        // BGV: GetPackedValue returns vector<int64_t>.
